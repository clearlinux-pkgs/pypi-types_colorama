...
Source0  : https://files.pythonhosted.org/packages/f5/c8/d5c5dabc9b19ee7c03748f354004e5f311470cb5d1373e33670160be368b/types-colorama-0.4.15.20240205.tar.gz
...
%prep
%setup -q -n types-colorama-0.4.15.20240205
cd %{_builddir}/types-colorama-0.4.15.20240205
pushd ..
cp -a types-colorama-0.4.15.20240205 buildavx2
popd
pushd ..
cp -a types-colorama-0.4.15.20240205 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707149374
