...
Version  : 0.4.6
Release  : 6
URL      : https://files.pythonhosted.org/packages/f0/2d/046d620ac3e8b6b75611212f01029675a8a00be7d09ba0c91d22183e7b06/types-colorama-0.4.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/f0/2d/046d620ac3e8b6b75611212f01029675a8a00be7d09ba0c91d22183e7b06/types-colorama-0.4.6.tar.gz
...
%prep
%setup -q -n types-colorama-0.4.6
cd %{_builddir}/types-colorama-0.4.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641943434
