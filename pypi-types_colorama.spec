...
Source0  : https://files.pythonhosted.org/packages/ec/dc/32636dc8e28f61f79e36f03ee7585cea33a13b5fe43c482a26d94c4cf3f7/types-colorama-0.4.15.3.tar.gz
...
%prep
%setup -q -n types-colorama-0.4.15.3
cd %{_builddir}/types-colorama-0.4.15.3
pushd ..
cp -a types-colorama-0.4.15.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668450631
