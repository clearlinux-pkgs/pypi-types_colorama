...
Source0  : https://files.pythonhosted.org/packages/9d/bd/d22677ab8604ffefb8eeb0405e18d99fa784c95d8e5ec93458f34e32d566/types-colorama-0.4.15.4.tar.gz
...
%prep
%setup -q -n types-colorama-0.4.15.4
cd %{_builddir}/types-colorama-0.4.15.4
pushd ..
cp -a types-colorama-0.4.15.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669055786
