...
Source0  : https://files.pythonhosted.org/packages/59/73/0fb0b9fe4964b45b2a06ed41b60c352752626db46aa0fb70a49a9e283a75/types-colorama-0.4.15.20240311.tar.gz
...
%prep
%setup -q -n types-colorama-0.4.15.20240311
cd %{_builddir}/types-colorama-0.4.15.20240311
pushd ..
cp -a types-colorama-0.4.15.20240311 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710173718
